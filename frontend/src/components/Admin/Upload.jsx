...
//                     <div className="flex md:w-full mt-6 gap-5 flex-col md:flex-row w-full">
//                         <div className="flex flex-col md:w-1/2">
//                             <label className="text-xl font-medium mb-2" htmlFor="quantity">Quantity</label>
//                             <input className="w-full px-2 py-1.5 border-2 border-gray-700 rounded-xl" placeholder="Quantity" type="number" id="quantity" name="quantity" required />
//                         </div>
//                     </div>
//                     <div className="flex md:w-full flex-col md:flex-row mt-7 w-[450px]">
//                         <div className="flex flex-col w-full">
