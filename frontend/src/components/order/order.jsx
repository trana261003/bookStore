...
//                   </td>
//                   <td className="px-6 py-4 border-b border-gray-200">₹{order.totalPrice.toFixed(2)}</td>
//                   <td className={`px-6 py-4 border-b border-gray-200 ${getOrderStatusColor(order.orderStatus)}`}>
//                     {order.orderStatus}
//                   </td>
//                   <td className={`px-6 py-4 border-b border-gray-200 ${getPaymentStatusColor(order.paymentStatus)}`}>
//                     {order.paymentStatus}
//                   </td>
//                 </tr>
//               ))}
